                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  IconButton(onPressed: (){Navigator.of(context).pushNamed(DeliveryMenProfileScreenByAdmin.id);},
                                 ...
                                 int id =   MemberList[index].id;
                                   ...
                                   String message = await ProductUploadingAndDispalyingFunctions().
                                    ...
                                    Navigator.of(context).pop();
                                     Navigator.of(context).pushNamed(SearchDetailsDeleteDEliveryMenScrn .id);
